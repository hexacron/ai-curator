...
*Last updated: 2026-05-10 07:53:42*
...
- **Go**: 46 repositories
- **JavaScript**: 34 repositories
- **Rust**: 22 repositories
...
**177,059 ⭐** | **JavaScript** | Updated: 2026-05-10
...
**39,139 ⭐** | **Python** | Updated: 2026-05-09
...
**25,174 ⭐** | **Python** | Updated: 2026-05-10
...
**19,179 ⭐** | **Python** | Updated: 2026-05-10
...
**18,699 ⭐** | **Python** | Updated: 2026-05-10
...
**12,195 ⭐** | **Rust** | Updated: 2026-05-10
...
**10,075 ⭐** | **JavaScript** | Updated: 2026-05-10
...
**9,669 ⭐** | **JavaScript** | Updated: 2026-05-10
...
**8,647 ⭐** | **Python** | Updated: 2026-05-10
...
**8,458 ⭐** | **Python** | Updated: 2026-05-10
...
### 13. [lamda](https://github.com/firerpa/lamda)
**7,778 ⭐** | **Python** | Updated: 2026-05-10
...
### 14. [osmedeus](https://github.com/j3ssie/osmedeus)
**6,228 ⭐** | **Go** | Updated: 2026-05-10
...
### 15. [Shadowbroker](https://github.com/BigBodyCobain/Shadowbroker)
**6,182 ⭐** | **Python** | Updated: 2026-05-10

Open-source intelligence for the global theater. Track everything from the corporate/private jets of the wealthy, and spy satellites, to seismic events in one unified interface. Hook an AI agent up to have it parse through data and find previously unseen correlations. The knowledge is available to all but rarely aggregated in the open, until now.

**Topics**: `air-force-one` `airforce1` `asdb` `cctv` `cctv-cameras`

---

### 16. [Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills)
**6,150 ⭐** | **Python** | Updated: 2026-05-10

754 structured cybersecurity skills for AI agents · Mapped to 5 frameworks: MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, D3FEND & NIST AI RMF · agentskills.io standard · Works with Claude Code, GitHub Copilot, Codex CLI, Cursor, Gemini CLI & 20+ platforms · 26 security domains · Apache 2.0

**Topics**: `ai-agents` `claude-code` `cloud-security` `cybersecurity` `devsecops`

---

### 17. [microsandbox](https://github.com/superradcompany/microsandbox)
**6,011 ⭐** | **Rust** | Updated: 2026-05-10
...
### 18. [robin](https://github.com/apurvsinghgautam/robin)
**4,978 ⭐** | **Python** | Updated: 2026-05-10

AI-Powered Dark Web OSINT Tool

**Topics**: `ai-tool` `darkweb` `darkweb-osint` `investigation-tool` `llm-powered`

---

### 19. [PurpleLlama](https://github.com/meta-llama/PurpleLlama)
**4,172 ⭐** | **Python** | Updated: 2026-05-09

Set of tools to assess and improve LLM security.

---

### 20. [ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)
**4,020 ⭐** | **Python** | Updated: 2026-05-09
