...
def generate_website():
    ...
    if not repos:
        ...
        <div class="col-span-full text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-2">The curator script did not find any repositories matching the criteria. Please check the logs or try again later.</p>
        </div>
        """
    else:
        for repo in repos:
